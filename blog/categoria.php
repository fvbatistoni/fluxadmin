...
<body class="fix-header card-no-border logo-center">
                            ...
                            <div class="card-body">
                                ...
                                <div id="tbl-div" class="table-responsive m-ts-40">
                                    <table id="datatable" class="datatable display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <tr v-for="cat in categoria" :class="'categoria-editar-' + cat.categoria_blog_id" :id="'categoria-id-' + cat.categoria_blog_id">
                                            <td class="text-center" width="110" style="cursor: crosshair "><i class="fa fa-list pt-2"></i></td>
                                            <td class="pt-4">{{cat.categoria_blog_nome}}</td>
                                                <td class="d-print-none text-right pt-4" width="140">
                                                    <a class="btn btn-sm text-white btn-primary waves-effect waves-light  menu-acces" title="editar categoria" data-toggle="tooltip" data-id="BlogAdmin:G" v-on:click="editar(cat)">
                ...
                <div class="modal-content">
                    <form action="${baseUri}/BlogAdmin/gravar_categoria/" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12 col-xs-12 col-sm-12">
                                <div class="mb-3">
                                    <label for="categoria_blog_exibir_home">Exibir na home?</label>
                                    <select class="form-control" name="categoria_blog_exibir_home" id="categoria_blog_exibir_home">
    ...
    <script src="blog/categoria.js"></script>
