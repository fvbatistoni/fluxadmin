...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
                        ...
                        <div class="card-body">
                            ...
                            <h3 class="text-center text-danger">
                                ...
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100.001px" height="70px" viewBox="0 0 100 68">
                                    <g id="large">
                                        <g transform="rotate(188.138 31 37)">
		...
		c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z" fill="none" stroke="#E43"></path>    <animateTransform attributeName="transform" begin="0s" dur="3s" type="rotate" from="0 31 37" to="360 31 37" repeatCount="indefinite" <="" animatetransform="">
                                            </animateTransform></g>
                                        <g id="small" transform="rotate(-282.207 78 21)">
