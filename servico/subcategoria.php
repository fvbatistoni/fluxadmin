...
<head>
    ...
    <title>${config_site_title} - Amamentação e uso de medicamentos - Subcategorias</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header card-no-border logo-center">
        ...
        <div id="modal-categoria" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="${baseUri}/Servico/gravar_subcategoria/" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="subcategoria_servico_tipo_sessao" id="subcategoria_servico_tipo_sessao" value="1">
                            ...
                            <div class="col-md-12 col-xs-12 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <select name="subcategoria_servico_categoria" id="subcategoria_servico_categoria" class="form-control" required>
                                        ...
                                        <option v-for="cat in categoria_primaria" :value="cat.categoria_servico_id" required>
    ...
    <script src="servico/subcategoria.js"></script>
    <script type="text/javascript">
        $('.menu-servico-subcategorias').addClass('active');
