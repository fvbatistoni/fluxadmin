...
<body class="fix-header card-no-border logo-center">
        ...
        <div id="modal-categoria" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="${baseUri}/Servico/gravar_categoria/" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="categoria_servico_tipo_sessao" id="categoria_servico_tipo_sessao" value="1">
    ...
    <script src="servico/categoria.js"></script>
    <script type="text/javascript">
        $('.menu-servico-categorias').addClass('active');
