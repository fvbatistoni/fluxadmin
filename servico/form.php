...
<head>
    ...
    <title>${config_site_title} - Amamentação e uso de medicamentos</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header card-no-border logo-center">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" id="APP" data-url="servico">
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Amamentação e uso de medicamentos</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Cadastros</a></li>
                            <li class="breadcrumb-item"><a href="${baseUri}/amamentacao/">Amamentação e uso de medicamentos</a></li>
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <h6 class="float-end" style="padding-top: 20px" data-id="Servico:G">
                            <a href="${baseUri}/servico/" class="btn btn-primary waves-effect waves-light">
            ...
            <!-- Start Page Content -->
            <form autocomplete="off" id="servico" method="post" action="${baseUri}/servico/gravar/" enctype="multipart/form-data">
                <input type="hidden" name="servico_tipo_sessao" id="servico_tipo_sessao" value="1">
    ...
    <script src="servico/form.js"></script>
    <script type="text/javascript">
        $('.menu-servico').addClass('active');
        var servico_categoria = '${servico_categoria}';
