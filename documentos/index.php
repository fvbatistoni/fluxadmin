            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Gerenciar ${documento_menu_admin}</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Clientes</a></li>
                            <li class="breadcrumb-item active"> Gerenciar ${documento_menu_admin}</li>
                        </ol>
                    </div>
                    <!-- Top Right Info -->
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <h6 class="float-end" style="padding-top: 20px">
                            <a id="novo-slide" data-id="Documentos:G" class="btn btn-primary waves-effect waves-light text-white menu-access" href="${baseUri}/documento-novo">
                                <i class="fa fa-plus-circle"></i> Novo
                                <span class="d-none d-xl-inline-block"> ${documento_singular}</span>
                            </a>
                        </h6>
                    </div>
                </div>
                                    ...
                                    <table id="datatable" class="datatable display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hidden-xs-down">Nome do Documento</th>
                                                <th class="hidden-xs-down">Documento</th>
                                                <th class="hidden-xs-down">Visualizado</th>
                                        ...
                                        <tbody>
                                            <tr v-for="dt in dados">
                                                ...
                                                <td class="hidden-xs-down">{{dt.documento_nome}}</td>
                                                <td class="hidden-xs-down">
                                                    <a  class="btn  waves-effect waves-light" v-on:click="render(dt)" data-id="Cliente:G">
                                                        <i class="fas fa-download"></i>
                                                    </a>
                                                </td>
                                                <td class="hidden-xs-down">
                                                    <a  class="btn  waves-effect waves-light"  data-id="Cliente:G">
                                                        <i  v-if="dt.documento_lido == 1 " class="fa fa-envelope-open"></i>
                                                        <i  v-else class="fa fa-envelope"></i>
                                                    </a>
                                                </td>
                                                <td class="d-print-none text-right" width="120">
                                                    <a class="btn btn-sm btn-primary waves-effect waves-light" data-toggle="tooltip" title="editar" :href="'${baseUri}/documento-editar/id/' + dt.documento_id">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-10 align-self-center">
                                                    <h3>{{dt.documento_cliente}}</h3>
                                                    <label>{{dt.documento_nome}} </label>
                                                    <a v-if="dt.documento_link != '' " :href="dt.documento_link" data-id="Cliente:G">
                                                        {{dt.documento_link}}
                                                    </a>
                                                    <a v-else>Não possui link</a>
                                                    <br>
                                                    <a v-if="dt.documento_url != '' " class="btn  waves-effect waves-light" v-on:click="render(dt)" data-id="Cliente:G">
                                                        <i class="fas fa-download"></i> Visualizar
                                                    </a>
                                                    <a v-else>Não possui documento</a>
                                                </div>
                                                        ...
                                                        <div class="col-12 align-self-start pb-4">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    <a class="dropdown-item" :href="'${baseUri}/documento-editar/id/' + dt.documento_id" data-id="Depoimento:G">
                                                                        <i class="fas fa-edit"></i>
                                                                        Editar</a>
                                                                    <a class="dropdown-item" v-on:click="remover(dt)" data-id="Depoimento:G">
                                                                        <i class="fas fa-trash"></i>
                                                                        Excluir</a>
