...
<head>
    ...
    <title>${config_site_title} - Galeria - Categorias</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 col-4 align-self-center">
                    <h6 class="float-end" style="padding-top: 20px">
                        <button id="nova-categoria" data-id="Galeria:G" class="btn btn-primary waves-effect waves-light text-white menu-access">
                        ...
                        <div class="card-body">
                            ...
                            <div id="tbl-div" class="table-responsive m-ts-40">
                                <table id="datatable" class="datatable display nowrap table table-hover table-striped table-bordered"
                                    ...
                                    <tbody>
                                    <tr v-for="cat in categoria" :class="'categoria-editar-' + cat.categoria_galeria_id" :id="'categoria-id-' + cat.categoria_galeria_id">
                                    <td class="text-center" width="110" style="cursor: crosshair "><i class="fa fa-list pt-2"></i></td>   
                                    <td class="pt-4">{{cat.categoria_galeria_nome}}</td>
                                        <td class="d-print-none text-right pt-4" width="140">
                                            <a class="btn btn-sm text-white btn-primary waves-effect waves-light  menu-acces"
                                               title="editar categoria" data-toggle="tooltip"
                                               data-id="Galeria:G"
                                               v-on:click="editar(cat)">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button class="btn btn-sm btn-danger menu-access"
                                                    data-id="categoria:G"
                                                    data-toggle="tooltip" title="remover categoria"
                                                    v-on:click="remover(cat)">
                            ...
                            <div class="row " id="mob-tbl">
                                    ...
                                    <div v-for="cat in categoria" :class="'categoria-editar-' + cat.categoria_galeria_id" :id="'categoria-id-' + cat.categoria_galeria_id" v-else>
                                        <div class="col-12">
                                            <div class="row  align-items-center">
                                                <div class="col-10 align-self-end pt-2">
                                                    <h4>{{cat.categoria_galeria_nome}}</h4>
    ...
    <div id="modal-categoria" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form action="${baseUri}/galeria/gravar_categoria/" method="post" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="modal-title" id="mySmallModalLabel"><span class="categoria-acao">Incluir</span> categoria</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="categoria_galeria_id" id="categoria_galeria_id">
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <div class="mb-3">
                                <label for="categoria_galeria_nome">Nome da categoria <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="categoria_galeria_nome" name="categoria_galeria_nome" maxlength="200" required>
                            </div>
                        </div>
                    </div>
...
<script src="galeria/categoria.js"></script>
