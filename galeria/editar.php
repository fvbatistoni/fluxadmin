...
<body class="fix-header card-no-border logo-center">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">${galeria_menu_admin}: ${galeria_nome}</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="${baseUri}/galeria/">Gerenciar ${galeria_menu_admin}</a></li>
                            <li class="breadcrumb-item active">${galeria_menu_admin}: ${galeria_nome}</li>
                        </ol>
                    </div>
                    <!-- Top Right Info -->
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <h6 class="float-end" style="padding-top: 20px">
                            <a href="${baseUri}/galeria/" data-id="Parceiro:L" class="btn btn-primary waves-effect waves-light text-white menu-access">
                            ...
                            <div class="card-body ">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-12 text-lg-right">
                                        <h6 class="float-end">
                                            <button id="nova-galeria" data-id="Galeria:G" class="btn btn-primary waves-effect waves-light text-white menu-access">
                                                <i class="fa fa-plus-circle"></i> <span class="d-none d-xl-inline-block">Enviar Imagens</span>
                                            </button>
                                ...
                                <div id="">
                                    ...
                                    <div class="row el-element-overlay" id="sort" v-show="galerias != null">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-12" v-for="gale in galerias" v-on:dblclick="add_class_remove(gale)" :id="'foto-galeria-'+gale.foto_galeria_id" :data-id="gale.foto_galeria_id" :data-position="gale.foto_galeria_pos">
                                            <div class="cardX">
                                                <div class="el-card-item">
                                                    <div class="el-card-avatar el-overlay-1" style="height: 100%!important;width:100%px!important;">
                                                        <img :src="'${baseUri}/media/galeria/'+ gale.foto_galeria_img" alt="user" :id="'img-galeria-id-'+gale.foto_galeria_id" :data-url="gale.foto_galeria_url" :data-remove="gale.foto_galeria_id" style="object-fit: cover;  height: 350px;width: 350px" />
                                                        <div class="el-overlay">
                                                            <ul class="el-info">
                                                                <li>
                                                                    <a class="btn default btn-outline image-popup-vertical-fit" data-lightbox="img" :href="'${baseUri}/media/galeria/'+ gale.foto_galeria_img">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="${baseUri}/galeria/enviar_img/id/${galeria_id}/" enctype="multipart/form-data" class="form text-center dropzone" method="post" id="form-galeria-img">
                        <div class="fallback">
    ...
    <script src="galeria/editar.js"></script>
