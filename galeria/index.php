...
<body class="fix-header card-no-border logo-center">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Gerenciar Fotos</h3>
                        <ol class="breadcrumb">
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                    ...
                                    <table id="datatable" class="datatable display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="hidden-xs-down">Categoria</th>
                                                <th class="hidden-xs-down">Status</th>
                                                <th class="d-print-none text-right">Ações</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr v-for="gale in galerias" :class="'galeria-editar-' + gale.galeria_id" :id="'galeria-id-' + gale.galeria_id">
                                                <td>{{gale.galeria_nome}}</td>
                                                <td>{{gale.categoria_galeria_nome}}</td>
                                                <td>

                                                <a v-on:click="mudar_status(gale)" style="cursor: pointer" data-toggle="tooltip" :title="gale.status_nome">
                                                        <span v-if="gale.galeria_status == 1"><i class="fa fa-2x fa-toggle-on text-primary"></i></span>
                                                        <span v-else><i class="fa fa-toggle-off fa-2x text-primary"></i></span>
                                                    </a>
                                                </td>
                                                <td class="d-print-none text-right" width="140">
                                                    <a class="btn btn-sm text-white btn-warning waves-effect waves-light  menu-acces" title="gerenciar galeria" data-toggle="tooltip" data-id="Galeria:G" :href="'${baseUri}/galeria/editar/id/'+gale.galeria_id+'/'">
                                                        <i class="fas fa-image"></i>
                                                    </a>

                                                    <button class="btn btn-sm btn-danger menu-access" data-id="Galeria:G" data-toggle="tooltip" title="remover Galeria" v-on:click="remover(gale)">
                                ...
                                <div class="row " id="mob-tbl">
                                    <div class="row" v-if="galerias == null">
                                        <div class="col-12 text-center">
                                            <label>Nenhum registro encontrado</label>
                                        </div>
                                    </div>
                                    <div v-for="gale in galerias" :class="'galeria-editar-' + gale.galeria_id" :id="'galeria-id-' + gale.galeria_id" v-else>
                                        <div class="col-12">
                                            <div class="row">
                                             
                                                <div class="col-10 align-self-center" >
                                                  <a  :href="'${baseUri}/galeria/editar/id/'+gale.galeria_id+'/'"> 
                                                   <h5 style="max-width: 35ch;overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">{{gale.galeria_nome}}</h5>
                    ...
                    <div class="modal-content">
                        <form action="${baseUri}/galeria/gravar/" method="post" enctype="multipart/form-data">
                            <div class="modal-header">
                                <h4 class="modal-title" id="mySmallModalLabel">Incluir Galeria</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="galeria_nome" name="galeria_nome" maxlength="150" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xs-12 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="galeria_categoria" id="galeria_categoria" class="form-control" required>
                                                ...
                                                <option v-for="cat in categorias" :value="cat.categoria_galeria_id">{{cat.categoria_galeria_nome}}</option>
                                ...
                                <div class="row d-none">
                                    <div class="col-md-12 col-xs-12 col-sm-12">
                                        <div class="mb-3">
                                            <label for="galeria_status">Galeria Status</label>
                                            <select name="galeria_status" id="galeria_status" class="form-control">
    ...
    <script src="galeria/index.js"></script>
