            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="${baseUri}/pagar/">Contas a Pagar</a></li>
                ...
                <div class="col-md-7 col-4 align-self-center menu-access" data-mod="Financeiro:G">
                    <h6 class="float-end" style="padding-top: 20px">
                        <a href="${baseUri}/pagar/" class="btn btn-primary waves-effect waves-light">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-body">
                            <form action="${baseUri}/pagar/save/" method="post" id="pagar-form">
                                <input type="hidden" id="id" name="id" value="${movimentacao_id}"/>
                                <input type="hidden" id="tipo" name="movimentacao_tipo" value="1"/>
                                <div class="rowss">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <span class="help float-end" data-toggle="tooltip"
                                                      title="Quem receberá o pagto. Ex: Companhia de Energia ou Prestador de Serviço">
                                                    <small><i class="fa fa-question-circle"></i></small>
                                                </span>
                                                <select class="selectpickerss form-control" id="fornecedor"
                                                        name="movimentacao_fornecedor"
                                                        data-style="form-control btn-primary">
                                                    <option value="">Selecione um fornecedor...</option>
                                                    <option :value="forn.id" v-for="forn in fornecedores">
                                                        {{forn.nome}}
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <span class="help float-end" data-toggle="tooltip"
                                                      title="Conta que será utilizada para o pagto.">
                                                    <small><i class="fa fa-question-circle"></i></small>
                                                </span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <span class="help float-end" data-toggle="tooltip"
                                                      title="Origem da conta / Destino do gasto.">
                                                    <small><i class="fa fa-question-circle"></i></small>
                                                </span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" id="forma" name="movimentacao_forma">
                                                    ...
                                                    <option value="11">Pagto Eletrônico (paypal, pagseguro)
                                                    </option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <span class="help float-end" data-toggle="tooltip"
                                                      title="Se informada, muda Status para PAGO automaticamente">
                                                    <small><i class="fa fa-question-circle"></i></small>
                                                </span>
                                                <input type="text" name="movimentacao_datapagto" id="datapagto"
                                                       class="form-control date-calendar"
                                                       value="${movimentacao_datapagto}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <span class="help float-end" data-toggle="tooltip"
                                                      title="Muda o status para PAGO automaticamente na data do Vencimento">
                                                    <small><i class="fa fa-question-circle"></i></small>
                                                </span>
