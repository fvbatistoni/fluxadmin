        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 col-4 align-self-center">
                    <h6 class="float-end menu-access" style="padding-top: 20px" data-id="Conta:G">
                        <a href="${baseUri}/conta/novo/" class="btn btn-primary waves-effect waves-light">
                            <i class="fa fa-plus-circle"></i> Nova <span
                                    class="hidden-xs-down">Conta</span>
                        </a>
                    </h6>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="tbl-div" class="table-responsive m-ts-40">
                                ...
                                <table id="datatable" class="datatable display nowrap table table-hover table-striped table-bordered"
                                    ...
                                    <tbody>
                                    <tr v-for="dt in dados" :id="'conta-' + dt.id">
                                        <td>{{dt.nome}}</td>
                                        <td>{{dt.banco}}</td>
                                        <td>R$ {{dt.saldo}}</td>
                                        <td width="150" class="text-center">
                                            <a v-on:click="mudar_status(dt)" style="cursor: pointer"
                                               data-toggle="tooltip" :title="dt.status_txt">
                                        ...
                                        <td class="d-print-none text-right" width="120">
                                            <a class="btn btn-sm btn-primary waves-effect waves-light text-white"
                                               ...
                                               :href="'${baseUri}/conta/editar/'+dt.id+'/'">
