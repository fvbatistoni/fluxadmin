...
<body>
<div class="warning-content" style="max-width: 99%">
    <h1>PHP STAFF</h1>
    <h1 style="font-size: 30px">SITE EM DESENVOLVIMENTO</h1>
    ...
    <p>
        Por favor volte em breve. <br />
        Estamos desenvolvendo este site.
    </p>
    <p>
        <a href="${baseUri}/admin/">Voltar</a>
    </p>
