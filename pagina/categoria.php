...
<body class="fix-header card-no-border logo-center">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <h6 class="float-end" style="padding-top: 20px">
                            <button id="nova-categoria" data-id="PaginaAdmin:G" class="btn btn-primary waves-effect waves-light text-white menu-access">
                                        ...
                                        <tbody>
                                            ...
                                            <td class="pt-4">{{cat.categoria_pagina_nome}}</td>
                                                ...
                                                <td class="d-print-none text-right pt-4" width="140">
                                                    <a class="btn btn-sm text-white btn-primary waves-effect waves-light  menu-acces" title="editar categoria" data-toggle="tooltip" data-id="PaginaAdmin:G" v-on:click="editar(cat)">
                                        ...
                                        <div class="col-12">
                                            <div class="row  align-items-center">
                                                <div class="col-10 align-self-end pt-2">
                                                    <h4>{{cat.categoria_pagina_nome}}</h4>
                                                    <label>Visível no topo? <span v-if="cat.categoria_pagina_topo == 1">Sim</span>
                                                    <span v-else>Não</span></label>
                                                        <label>Visível no rodapé? <span v-if="cat.categoria_pagina_rodape == 1">Sim</span>
                                                    <span v-else>Não</span></label>
    ...
    <script src="pagina/categoria.js"></script>
