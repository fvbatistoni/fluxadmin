            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 col-4 align-self-center">
                    <h6 class="float-end" style="padding-top: 20px">
                        <a id="novo-pagina" data-id="PaginaAdmin:G" class="btn btn-primary waves-effect waves-light text-white menu-access" href="${baseUri}/nova-pagina/">
                        <i class="fa fa-plus-circle"></i> Nova
                                <span class="d-none d-xl-inline-block">Página</span>
                        </a>
                    </h6>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="tbl-div" class="table-responsive m-ts-40">
                                <table id="datatable" class="datatable display nowrap table table-hover table-striped table-bordered"
                                    ...
                                    <tbody>
                                    <tr v-for="post in posts" :class="'pagina-editar-' + post.pagina_id" :id="'pagina-id-' + post.pagina_id">
                                        ...
                                        <td class="d-print-none text-right" width="140">
                                            <a class="btn btn-sm text-white btn-primary waves-effect waves-light  menu-acces"
                                               title="editar Página" data-toggle="tooltip"
                                               data-id="PaginaAdmin:G"
                                               :href="'${baseUri}/editar-pagina/id/' + post.pagina_id">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button class="btn btn-sm btn-danger menu-access"
                                                    data-id="PaginaAdmin:G"
                                                    data-toggle="tooltip" title="remover Página"
                                                    v-on:click="remover(post)">
                            ...
                            <div class="row " id="mob-tbl">
                                    ...
                                    <div v-for="post in posts" :class="'pagina-editar-' + post.pagina_id" :id="'pagina-id-' + post.pagina_id" v-else>
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-10 align-self-center">
                                                    <h5 style="max-width: 35ch;overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">{{post.pagina_titulo}}</h5>
                                                    <label>{{post.categoria_pagina_nome}}</label>
                                                </div>
                                                <div class="col-2 align-self-start pt-0 mt-0 text-right">
                                                        ...
                                                        <div class="col-12 align-self-start pb-1">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    <a class="dropdown-item"  data-id="PaginaAdmin:G" :href="'${baseUri}/editar-pagina/id/' + post.pagina_id">
                                                                        <i class="fas fa-edit"></i>
                                                                        Editar</a>

                                                                    <a class="dropdown-item"  v-on:click="remover(post)" data-id="PaginaAdmin:G">
                                                                        <i class="fas fa-trash"></i>
                                                                        Excluir</a>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <a v-on:click="mudar_status(post)" style="cursor: pointer" data-id="Depoimento:G" data-toggle="tooltip" :title="post.pagina_status_nome">
                                                        <span v-if="post.pagina_status == 1"><i class="fa fa-2x fa-toggle-on text-primary"></i></span>
                                                        <span v-else><i class="fa fa-toggle-off fa-2x text-primary"></i></span>
                                                    </a>
                                                        </div>
