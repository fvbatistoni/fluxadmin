                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Gerenciar ${produto_menu_admin}</li>
                        </ol>
                    </div>
                    <!-- Top Right Info -->
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <h6 class="float-end" style="padding-top: 20px">
                            <a id="novo-produto" data-id="ProdutosAdmin:G" class="btn btn-primary waves-effect waves-light text-white menu-access" href="${baseUri}/produto-novo/">
                                <i class="fa fa-plus-circle"></i> Nova
                                <span class="d-none d-xl-inline-block">${produto_singular}</span>
                            </a>
                        </h6>
                    </div>
                </div>
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                    ...
                                    <table id="datatable" class="datatable display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="">Categoria <i class="fa fa-sort" aria-hidden="true" style="cursor: pointer"></i></th>
                                                <th class="">Subcategoria <i class="fa fa-sort" aria-hidden="true" style="cursor: pointer"></i></th>                                                
                                                <th class="hidden-xs-down">Status</th>
                                                <th class="d-print-none text-right">Ações</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr v-for="post in posts" :class="'produto-editar-' + post.produto_id" :id="'produto-id-' + post.produto_id">
                                                <td class="">{{post.produto_titulo}}</td>
                                                <td class="">{{post.categoria_produto_nome}}</td>
                                                <td class="">{{post.subcategoria_produto_nome}}</td>
                                                <td class="" width="80">
                                                    <a v-on:click="mudar_status(post)" style="cursor: pointer" data-id="Produtos:G" data-toggle="tooltip" :title="post.produto_status_nome">
                                                ...
                                                <td class="d-print-none text-right" width="180">
                                                    <a class="d-none btn btn-sm text-white btn-warning waves-effect waves-light  menu-acces" title="fotos" data-toggle="tooltip" data-id="ProdutosAdmin:G" :href="'${baseUri}/produto-fotos/id/' + post.produto_id">
                                                        <i class="fas fa-photo"></i>
                                                    </a>

                                                    <a class="btn btn-sm text-white btn-primary waves-effect waves-light  menu-acces" title="editar produto" data-toggle="tooltip" data-id="ProdutosAdmin:G" :href="'${baseUri}/produto-editar/id/' + post.produto_id">
                                ...
                                <div class="row " id="mob-tbl">
                                    ...
                                    <div v-for="post in posts" :class="'produto-editar-' + post.produto_id" :id="'produto-id-' + post.produto_id" v-else>
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-10 align-self-center">
                                                    <h3>{{post.produto_titulo}}</h3>
                                                    <label>{{post.categoria_produto_nome}}</label>
                                                    <br>
                                                    <label>&nbsp;&nbsp;{{post.subcategoria_produto_nome}}</label>
                                                </div>
