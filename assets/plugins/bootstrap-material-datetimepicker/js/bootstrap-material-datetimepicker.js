   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '</div>' +
                         '</div>' +
                         '<div class="dtp-buttons text-center">' +
                         '<button class="dtp-btn-now btn btn-flat hidden">' + this.params.nowText + '</button>' +
                         '<button class="dtp-btn-clear btn btn-flat btn-warning">' + this.params.clearText + '</button> &nbsp;' +
                         '<button class="dtp-btn-cancel btn btn-inverse m-r-10">' + this.params.cancelText + '</button>' +
                         '<button class="ml-2 dtp-btn-ok btn btn-primary">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
