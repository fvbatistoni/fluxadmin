...
<head>
    ...
    <!--    <title>${config_site_title} - Blog - Categorias</title>-->
    <title> ${faq_menu_admin} - Categorias | ${config_site_title} -</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header card-no-border logo-center">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <h6 class="float-end" style="padding-top: 20px">
                            <button id="nova-categoria" data-id="BlogAdmin:G" class="btn btn-primary waves-effect waves-light text-white menu-access">
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                        ...
                                        <thead>
                                            <tr>
                                                <td title="Arraste o slide para ordenar" data-toggle="tooltip"><small>
                                                    ...
                                                    Posição </td>
                                                <th>Nome <i class="fa fa-sort" aria-hidden="true" style="cursor: pointer"></i>
                                                </th>
                                                <th class="d-print-none text-right">Ações</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr v-for="cat in categoria" :class="'categoria-editar-' + cat.categoria_faq_id" :id="'categoria-id-' + cat.categoria_faq_id">
                                                <td class="text-center" width="110" style="cursor: crosshair "><i class="fa fa-list pt-2"></i></td>
                                                <td class="pt-4">{{cat.categoria_faq_nome}}</td>
                                                <td class="d-print-none text-right pt-4" width="140">
                                                    <a class="btn btn-sm text-white btn-primary waves-effect waves-light  menu-acces" title="editar categoria" data-toggle="tooltip" data-id="FaqAdmin:G" v-on:click="editar(cat)">
                                ...
                                <div class="row " id="mob-tbl">
                                    ...
                                    <div v-for="cat in categoria" :class="'categoria-editar-' + cat.categoria_blog_id" :id="'categoria-id-' + cat.categoria_blog_id" v-else>
                                        <div class="col-12">
                                            <div class="row  align-items-center">
                                                <div class="col-10 align-self-end pt-2">
                                                    <p>{{cat.categoria_faq_nome}}</p>
                                                </div>
    ...
    <script src="faq/categoria.js"></script>
    <script type="text/javascript">
        $('.menu-conteudo').addClass('active');
        $('.menu-faq-categorias').addClass('active');
