var vm = new Vue({
    ...
    methods: {
        listar_categorias:function(){
            let url = baseUri + "/ServicoGestacao/lista_categoria_combo/";
            let self = this;
        ...
        listar_subcategorias_by_categoria:function(){
            let url = baseUri + "/ServicoGestacao/lista_sub_by_categoria/";
        ...
        listar_subcategorias_filhas_by_subcategoria:function(){
            let url = baseUri + "/ServicoGestacao/lista_subcategoria_filha_by_subcategoria/";
...
$(document).ready(function() {
    ...
    $('#servico_nome').on('blur', function () {
        let url = baseUri + "/ServicoGestacao/url";
        let value = $(this).val();
