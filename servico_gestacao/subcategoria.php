...
<head>
    ...
    <title>${config_site_title} - Gestação e uso de medicamentos - Subcategorias</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header card-no-border logo-center">
        ...
        <div id="modal-categoria" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="${baseUri}/ServicoGestacao/gravar_subcategoria/" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="subcategoria_servico_tipo_sessao" id="subcategoria_servico_tipo_sessao" value="2">
                        <div class="modal-header">
                            <h4 class="modal-title" id="mySmallModalLabel"><span class="categoria-acao">Inlcuir</span> subcategoria</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="subcategoria_servico_id" id="subcategoria_servico_id">
                            <div class="col-md-12 col-xs-12 col-sm-12">
                                <div class="mb-3">
                                    <label for="subcategoria_servico_nome">Nome da subcategoria <span class="text-danger">*</span></label>
    ...
    <script src="servico_gestacao/subcategoria.js"></script>
    <script type="text/javascript">
        $('.menu-servico-gestacao-subcategoria').addClass('active');
