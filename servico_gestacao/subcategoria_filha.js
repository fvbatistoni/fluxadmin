...
var vm = new Vue({
    ...
    methods: {
        listar: function () {
            var url = baseUri + "/ServicoGestacao/lista_subcategoria_filha/";
            var self = this;
        ...
        remove: function (id) {
            var url_remove = baseUri + "/ServicoGestacao/remover_subcategoria_filha/";
...
$(document).ready(function () {
    ...
    /*setTimeout(function () {
        table.on("row-reorder", function (e, diff, edit) {
            var url = baseUri + "/ServicoGestacao/ordenar/";
            if (diff.length > 0) {
