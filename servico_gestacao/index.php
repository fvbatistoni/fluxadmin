...
<head>
    ...
    <title>Gestação e uso de medicamentos | ${config_site_title}</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header card-no-border logo-center">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Gerenciar Gestação e uso de medicamentos</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">CRM</a></li>
                            <li class="breadcrumb-item active">Gerenciar Gestação e uso de medicamentos</li>
                        </ol>
                    </div>
                    <!-- Top Right Info -->
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <h6 class="float-end menu-access" style="padding-top: 20px" data-id="Servico:G">
                            <a href="${baseUri}/gestacao-novo/" class="btn btn-primary waves-effect waves-light">
                                    ...
                                    <tbody>
                                        <tr v-for="dt in dados" :class=" 'servico-editar-' + dt.id" :id="'servico-id-' + dt.id">
                                            ...
                                            <td class="d-print-none text-right" width="120">
                                                <a class="btn btn-sm btn-primary waves-effect waves-light text-white" data-toggle="tooltip" title="editar" :href="'${baseUri}/gestacao-editar/'+dt.id+'/'">
                                                    ...
                                                    <div class="col-12 align-self-start pb-4">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <a class="dropdown-item" data-id="Servico:G" :href="'${baseUri}/gestacao-editar/'+dt.id+'/'">
                                                                    <i class="fas fa-edit"></i>
                                                                    Editar</a>
    ...
    <script src="servico_gestacao/index.js"></script>
    <script type="text/javascript">
        var tipo_sessao = 2;
        $('.menu-servico-gestacao').addClass('active');
        $('.menu-servico-gestacao-gerenciar').addClass('active');
    </script>
</body>
