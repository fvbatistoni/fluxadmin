...
<body class="fix-header card-no-border logo-center">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Gerenciar Categorias</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <h6 class="float-end" style="padding-top: 20px">
                            <button id="nova-categoria" data-id="ProdutosAdmin:G" class="btn btn-primary waves-effect waves-light text-white menu-access">
                                ...
                                <span class="d-none d-xl-inline-block">categoria</span>
                            </button>
                        </h6>
                    </div>
                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row  align-items-center">
                                                <div class="col-10 align-self-end pt-2">
                                                    <h4>{{cat.categoria_servico_nome}}</h4>
                                                </div>
        ...
        <div id="modal-categoria" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="${baseUri}/ServicoGestacao/gravar_categoria/" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="categoria_servico_tipo_sessao" id="categoria_servico_tipo_sessao" value="2">
                        <div class="modal-header">
                            <h4 class="modal-title" id="mySmallModalLabel"><span class="categoria-acao">Inlcuir</span> categoria</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="categoria_servico_id" id="categoria_servico_id">
                            <div class="col-md-12 col-xs-12 col-sm-12">
                                <div class="mb-3">
                                    <label for="categoria_servico_nome">Nome da categoria <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="categoria_servico_nome" name="categoria_servico_nome" maxlength="200" required>
                                </div>
                            </div>
                        </div>
    ...
    <script src="servico_gestacao/categoria.js"></script>
    <script type="text/javascript">
        $('.menu-servico-gestacao-categoria').addClass('active');
