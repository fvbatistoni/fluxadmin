...
<head>
    ...
    <title>Tipos | ${config_site_title}</title>
    <!-- Bootstrap Core CSS -->
...
<div id="main-wrapper">
    ...
    <!-- Page wrapper  -->
    <div class="page-wrapper" id="APP" data-url="tipo">
        <!-- Container fluid  -->
        <div class="container-fluid">
            <!-- Bread crumb and right sidebar toggle -->
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">Tipos</h3>
                    <ol class="breadcrumb">
                ...
                <div class="col-md-7 col-4 align-self-center">
                    <h6 class="float-end" style="padding-top: 20px">
                        <a class="btn btn-primary waves-effect waves-light menu-access"
                           data-id="Tipo:G"
                           href="${baseUri}/tipo/novo/">
                            <i class="fa fa-plus-circle"></i> Novo <span
                                    class="hidden-xs-down">Tipo</span>
                        </a>
                    </h6>
                </div>
            </div>
                                    ...
                                    <tr v-for="dt in dados" :id="'tipo-' + dt.id">
                                        ...
                                        <td class="d-print-none text-right" width="120">
                                            <a class="btn btn-sm btn-primary waves-effect waves-light text-white"
                                               ...
                                               :href="'${baseUri}/tipo/editar/id/'+dt.id+'/'">
