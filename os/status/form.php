...
<head>
    ...
    <title>Status da OS | ${config_site_title}</title>
    <!-- Bootstrap Core CSS -->
...
<div id="main-wrapper">
    ...
    <!-- Page wrapper  -->
    <div class="page-wrapper" id="APP" data-url="status">
        <!-- Container fluid  -->
        <div class="container-fluid">
            <!-- Bread crumb and right sidebar toggle -->
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">Status</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Ordem de Serviço</a></li>
                        <li class="breadcrumb-item"><a href="${baseUri}/status/">Status</a></li>
                ...
                <div class="col-md-7 col-4 align-self-center">
                    <h6 class="float-end" style="padding-top: 20px">
                        <a class="btn btn-primary waves-effect waves-light" href="${baseUri}/status/">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-body">
                            <div class="content">
                                <form autocomplete="off" method="post" action="${baseUri}/status/gravar/">
                                    ...
                                    <section>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                <div class="mb-3">
                                                    <label for="status_nome">Nome / Tipo</label>
                                                    <span class="text-danger">*</span>
                                                    <input type="text" name="status_nome" id="status_nome"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <label for="status_cpf">Observações
                                                    </label>
                                                        <span class="float-end"><small> <i class="fa fa-exclamation-circle"></i> Observações Internas</small></span>
                                                    <textarea name="status_obs" id="status_obs"
                                                           class="form-control"
                                                           placeholder="Observações Internas">${status_obs}</textarea>
                                                </div>
                                            </div>
